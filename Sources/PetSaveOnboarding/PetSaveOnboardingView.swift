...
struct PetSaveOnboardingView: View {
  ...
  private var onNext: (_ currentStep: Int) -> Void = { _ in }
  ...
  public func onNext(
    ...
    var petOnboardingView = self
    petOnboardingView.onNext = action
    return petOnboardingView
  }
  
  public func onSkip (action: @escaping () -> Void) -> Self {
    var petOnboardingView = self
    petOnboardingView.onSkip = action
    return petOnboardingView
  }
